#!/bin/bash
# 고성능 Task Definition 생성 (8 vCPU, 16GB)
...
# Task Definition 등록
echo -e "${YELLOW}고성능 Task Definition 등록 중...${NC}"
...
echo -e "\n${GREEN}✅ 완료! (8 vCPU, 16GB)${NC}"
echo -e "${YELLOW}비용: 약 \$0.09/시간 (기존의 2배)${NC}\n"
