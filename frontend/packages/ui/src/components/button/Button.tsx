...
const buttonVariants = cva(
  'inline-flex items-center justify-center gap-[10px] px-6 py-[10px] rounded-full text-18sb text-center transition-colors cursor-pointer disabled:pointer-events-none',
  {
    variants: {
      variant: {
        primary: '',
